...
<script
	src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.min.js"></script>
    	...
    	.three-d-effect {
	font-size: 50px; color : black; /* Light color */
...
<%
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <strong>Team Name:</strong> <%= pbean.getTeamName() %><br>
                            <strong>Guide Name:</strong> <%= pbean.getGuideName() %><br>
                            <strong>Project Problem:</strong> <%= pbean.getProjectProblem() %><br>
                            <strong>Project PPT :</strong> <%= pbean.getProjectPpt() %><br>
                            <!-- Add more project details here -->
                        </p>
						<a href="<%= pbean.getProjectPpt() %>" class="btn btn-primary" style="background:#fed136;"
							target="_blank">Open PPT</a> 
							<a href="  <%=pbean.getGithupUrl()%> " class="btn btn-primary" style="background:#fed136;" target="_blank">Visit GitHub</a>
                    </div>
                </div>
            </div>
            <%
   ...
   <script>
    function openPPT(projectName, pptData) {
        var pptBlob = new Blob([atob(pptData)], { type: 'application/vnd.ms-powerpoint' });
